        ...
        <View className="flex-1 bg-gray-50">
            ...
            <ScrollView className="flex-1 -mt-10 px-5" showsVerticalScrollIndicator={false}>
                ...
                <View className="bg-white rounded-2xl shadow-sm p-6 items-center border border-gray-100 mb-5">
                    <View className="h-20 w-20 bg-gray-200 rounded-full mb-3 items-center justify-center -mt-12 border-4 border-white shadow-sm">
                        <Text className="text-3xl font-bold text-gray-500">AP</Text>
                    </View>
                    ...
                    <View className="bg-green-100 px-3 py-1 rounded-full">
                        <Text className="text-green-700 text-xs font-bold">{user.status}</Text>
                    </View>
                </View>
                ...
                <View className="bg-white rounded-2xl p-5 mb-10 shadow-sm border border-gray-100">
                    ...
                    <TouchableOpacity className="mt-4 py-2 bg-gray-50 rounded-lg items-center">
